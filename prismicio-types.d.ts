...
/**
 * Item in *Features → Default → Primary → featureCard*
 */
export interface FeaturesSliceDefaultPrimaryFeaturecardItem {
  /**
   * Icon field in *Features → Default → Primary → featureCard*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.featurecard[].icon
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  icon: prismic.SelectField<"calendar" | "bargraph" | "clover" | "hourglass">;

  /**
   * Title field in *Features → Default → Primary → featureCard*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.featurecard[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.TitleField;

  /**
   * Description field in *Features → Default → Primary → featureCard*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.featurecard[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
...
export interface FeaturesSliceDefaultPrimary {
  ...
  /**
   * featureCard field in *Features → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.featurecard[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  featurecard: prismic.GroupField<
...
/**
 * Item in *Testimonials → Default → Primary → Testimonials Group*
 */
export interface TestimonialsSliceDefaultPrimaryTestimonialsGroupItem {
  /**
   * Testimonial field in *Testimonials → Default → Primary → Testimonials Group*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: testimonials.default.primary.testimonials_group[].testimonial
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface TestimonialsSliceDefaultPrimary {
  ...
  /**
   * Testimonials Group field in *Testimonials → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: testimonials.default.primary.testimonials_group[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  testimonials_group: prismic.GroupField<
    Simplify<TestimonialsSliceDefaultPrimaryTestimonialsGroupItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceHorizontal,
      TestimonialsSlice,
      TestimonialsSliceDefaultPrimaryTestimonialsGroupItem,
